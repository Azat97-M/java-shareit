...
public interface BookingService {
    ...
    List<BookingDtoOut> findAllByBooker(Long userId, String state, Integer from, Integer size);

    List<BookingDtoOut> findAllByOwner(Long userId, String state, Integer from, Integer size);
}
